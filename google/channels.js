...
async function watchChanges(drawingFileId, channelName) {
    ...
    const channel = {
      ...
      type: 'webhook',
      address: "https://8e96-2601-188-c880-e80-89bd-da2b-4224-c226.ngrok-free.app/api/receiveDrawingUpdate/" + channelName,  // Your server's endpoint to receive changes
...
setTimeout(()=>{
  //stopChannel("channel7").catch(err=>console.log(err));
  //watchChanges("1S5Ak-T4L6gZeN5xF93OMpigSl3YpAEBU8jMvUQA4u38", "channel8").catch(err=>console.log(err));
}, 5000)
